      ...
      <section className={"mt-20 pd-12 space-y-10 md:space-y-20 px-5"}>
        ...
        <section id={"features"} className={"bg-gray-50 py-20"}>
            <div className={"container mx-auto px-4 md:px-6 text-center"}>
                ...
                <p className={"mx-auto mt-3 max-w-[700px] text-gray-500 md:text-xl/relaxed"}>
                    Our platform provides you with all the tools you need to handle shared expenses with ease.
                </p>
        ...
        <section id={"how-it-works"} className={"py-20"}>
            <div className={"container mx-auto px-4 md:px-6 text-center"}>
                ...
                <p className={"mx-auto mt-3 max-w-[700px] text-gray-500 md:text-xl/relaxed"}>
                    Follow these simple steps to start tracking and split expenses with friends and family.
                </p>
